...
typedef struct {
  volatile unsigned long HSMCI_CR;        /**< \brief (Hsmci Offset: 0x00) Control Register */
  volatile unsigned long HSMCI_MR;        /**< \brief (Hsmci Offset: 0x04) Mode Register */
  volatile unsigned long HSMCI_DTOR;      /**< \brief (Hsmci Offset: 0x08) Data Timeout Register */
  volatile unsigned long HSMCI_SDCR;      /**< \brief (Hsmci Offset: 0x0C) SD/SDIO Card Register */
  volatile unsigned long HSMCI_ARGR;      /**< \brief (Hsmci Offset: 0x10) Argument Register */
  volatile unsigned long HSMCI_CMDR;      /**< \brief (Hsmci Offset: 0x14) Command Register */
  volatile unsigned long HSMCI_BLKR;      /**< \brief (Hsmci Offset: 0x18) Block Register */
  volatile unsigned long HSMCI_CSTOR;     /**< \brief (Hsmci Offset: 0x1C) Completion Signal Timeout Register */
  volatile unsigned long HSMCI_RSPR[4];   /**< \brief (Hsmci Offset: 0x20) Response Register */
  volatile unsigned long HSMCI_RDR;       /**< \brief (Hsmci Offset: 0x30) Receive Data Register */
  volatile unsigned long HSMCI_TDR;       /**< \brief (Hsmci Offset: 0x34) Transmit Data Register */
  volatile unsigned long Reserved1[2];
  volatile unsigned long HSMCI_SR;        /**< \brief (Hsmci Offset: 0x40) Status Register */
  volatile unsigned long HSMCI_IER;       /**< \brief (Hsmci Offset: 0x44) Interrupt Enable Register */
  volatile unsigned long HSMCI_IDR;       /**< \brief (Hsmci Offset: 0x48) Interrupt Disable Register */
  volatile unsigned long HSMCI_IMR;       /**< \brief (Hsmci Offset: 0x4C) Interrupt Mask Register */
  volatile unsigned long HSMCI_DMA;       /**< \brief (Hsmci Offset: 0x50) DMA Configuration Register */
  volatile unsigned long HSMCI_CFG;       /**< \brief (Hsmci Offset: 0x54) Configuration Register */
  volatile unsigned long Reserved2[35];
  volatile unsigned long HSMCI_WPMR;      /**< \brief (Hsmci Offset: 0xE4) Write Protection Mode Register */
  volatile unsigned long HSMCI_WPSR;      /**< \brief (Hsmci Offset: 0xE8) Write Protection Status Register */
  volatile unsigned long Reserved3[69];
  volatile unsigned long HSMCI_FIFO[256]; /**< \brief (Hsmci Offset: 0x200) FIFO Memory Aperture0 */
} Hsmci;
